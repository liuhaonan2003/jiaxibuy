...
class ModuleAction extends AdminbaseAction {
	...
	function insert(){	
		...
		if(empty($_POST['emptytable'])){
			...
			$db->execute("INSERT INTO `".C('DB_PREFIX')."field` VALUES ('', '".$moduleid."', 'createtime', '".L('createtime')."', '', '1', '0', '0', 'date', '', '', 'datetime', '','1','',  '93', '1', '1')");
			...
			$db->execute("INSERT INTO `".C('DB_PREFIX')."field` VALUES ('', '".$moduleid."', 'template', '".L('template')."', '', '0', '0', '0', '', '', '', 'template', '','1','', '98', '1', '1')");
			...
			$db->execute("INSERT INTO `".C('DB_PREFIX')."field` VALUES ('', '".$moduleid."', 'createtime', '".L('createtime')."', '', '1', '0', '0', 'date', '', '', 'datetime', '','0','',  '93', '1', '1')");
